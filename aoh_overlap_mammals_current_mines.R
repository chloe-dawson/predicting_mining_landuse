# =============================================================================
# Per-mine mining x AOH overlap  +  Per-species AOH change — MAMMALS
#                                                      (current / expansion)
#
...
# originals ([id]_1.tif) across three mammals subfolders: freshwater,
# marine_and_terrestrial, and terrestrial_only.
# =============================================================================
