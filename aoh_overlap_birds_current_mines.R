...
species_path    <- "your-file-path/data/species_selection/birds_species_selection.xlsx"
output_path     <- "your-file-path/outputs/birds_per_mine_overlap_current.csv"
aoh_change_path <- "your-file-path/outputs/birds_aoh_change_current.csv"
